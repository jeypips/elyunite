...
--
-- Host: localhost
-- Generation Time: Apr 13, 2020 at 11:14 PM
...
INSERT INTO `accounts` (`id`, `firstname`, `middlename`, `lastname`, `username`, `password`, `groups`, `office`, `system_log`) VALUES
(1, 'John Paul', 'Gwapo', 'Balanon', 'admin', 'asdasd', 1, 1, '2019-08-27 09:52:26'),
(2, 'Ashley', 'As', 'Ebreo', 'user', 'user', 2, 0, '2019-08-27 14:40:36'),
(3, 'Nikki', 'daf', 'adfd', 'nikkie', '124124214124', 4, 1, '2019-10-22 09:25:49');
...
CREATE TABLE `offices` (
  ...
  `office_description` varchar(500) DEFAULT NULL,
  `system_log` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `offices` (`id`, `office_name`, `office_description`, `system_log`) VALUES
(1, 'OPS', 'Office of Provincial Strategy', '2020-04-05 21:38:14');
...
INSERT INTO `surveys` (`id`, `name`, `description`, `office`, `system_log`) VALUES
(1, 'Elyunite Survey', 'A description of elyunite sruvey', 1, '2019-10-28 20:40:29');
